...
public class WebConfigurer implements WebFluxConfigurer {
    ...
    RouterFunction<ServerResponse> staticResourceRouter() {
        return RouterFunctions.resources("/content/**", new FileSystemResource("./src/main/webapp/content/"));
    }

    //    @Bean
    //    RouterFunction<ServerResponse> staticResourceRouter(){
    //        return RouterFunctions.resources("/content/**", new ClassPathResource("/static/"));
    //    }
